...
function getDanjyonData() {
    ...
    function setDanjyonName(results) {
        ...
        for (var i = 0; i <= results.length - 1; i++) {
            ...
            // 新しいHTML要素を作成
            var danjyonHtml = '<div><img class="note_button_image" id="' + danjyon.danjyon_id + '" src="../image/danjyonSelectButton.png" onclick="modalOpen();searchDanjyonData(this)" value="' + danjyon.danjyon_id + '"><p class="note_button_text">' + danjyon.danjyon_name + '</p></div>';
            // 作成した要素を追加
